...
| nginx:1.19 | rule | p_gate | **BLOCK** | 153 | 0 |
| nginx:1.19 | rule | p_gate_with_exceptions | **BLOCK** | 153 | 0 |
| nginx:1.19 | agent | p_gate | **BLOCK** | 153 | 0 |
| nginx:1.19 | agent | p_gate_with_exceptions | **BLOCK** | 153 | 0 |
...
| python:3.8 | rule | p_gate | pass | 585 | 0 |
| python:3.8 | rule | p_gate_with_exceptions | pass | 585 | 0 |
| python:3.8 | agent | p_gate | pass | 584 | 0 |
| python:3.8 | agent | p_gate_with_exceptions | pass | 584 | 0 |
| vulnerables/web-dvwa | rule | p_gate | **BLOCK** | 744 | 0 |
| vulnerables/web-dvwa | rule | p_gate_with_exceptions | **BLOCK** | 744 | 0 |
| vulnerables/web-dvwa | agent | p_gate | **BLOCK** | 687 | 0 |
| vulnerables/web-dvwa | agent | p_gate_with_exceptions | **BLOCK** | 687 | 0 |
| bkimminich/juice-shop | rule | p_gate | pass | 37 | 0 |
| bkimminich/juice-shop | rule | p_gate_with_exceptions | pass | 36 | 1 |
| bkimminich/juice-shop | agent | p_gate | pass | 37 | 0 |
| bkimminich/juice-shop | agent | p_gate_with_exceptions | pass | 36 | 1 |
...
| ruby:2.5-slim | agent | p_gate | **BLOCK** | 116 | 0 |
| ruby:2.5-slim | agent | p_gate_with_exceptions | **BLOCK** | 116 | 0 |
...
| php:7.4-apache | rule | p_gate | **BLOCK** | 329 | 0 |
| php:7.4-apache | rule | p_gate_with_exceptions | **BLOCK** | 329 | 0 |
| php:7.4-apache | agent | p_gate | **BLOCK** | 325 | 0 |
| php:7.4-apache | agent | p_gate_with_exceptions | **BLOCK** | 325 | 0 |
| rust:1.56-slim | rule | p_gate | pass | 171 | 0 |
| rust:1.56-slim | rule | p_gate_with_exceptions | pass | 171 | 0 |
| rust:1.56-slim | agent | p_gate | pass | 171 | 0 |
| rust:1.56-slim | agent | p_gate_with_exceptions | pass | 171 | 0 |
| node:12 | rule | p_gate | **BLOCK** | 115 | 0 |
| node:12 | rule | p_gate_with_exceptions | **BLOCK** | 115 | 0 |
| node:12 | agent | p_gate | **BLOCK** | 114 | 0 |
| node:12 | agent | p_gate_with_exceptions | **BLOCK** | 114 | 0 |
| python:2.7 | rule | p_gate | **BLOCK** | 1302 | 0 |
| python:2.7 | rule | p_gate_with_exceptions | **BLOCK** | 1302 | 0 |
| python:2.7 | agent | p_gate | **BLOCK** | 1301 | 0 |
| python:2.7 | agent | p_gate_with_exceptions | **BLOCK** | 1301 | 0 |
| golang:1.23-alpine | rule | p_gate | pass | 59 | 0 |
| golang:1.23-alpine | rule | p_gate_with_exceptions | pass | 59 | 0 |
| golang:1.23-alpine | agent | p_gate | pass | 57 | 0 |
| golang:1.23-alpine | agent | p_gate_with_exceptions | pass | 57 | 0 |
| ruby:3.3-slim | rule | p_gate | pass | 5 | 0 |
| ruby:3.3-slim | rule | p_gate_with_exceptions | pass | 5 | 0 |
| ruby:3.3-slim | agent | p_gate | pass | 3 | 0 |
| ruby:3.3-slim | agent | p_gate_with_exceptions | pass | 3 | 0 |
...
| mcr.microsoft.com/dotnet/runtime:8.0 | rule | p_gate | pass | 1 | 0 |
| mcr.microsoft.com/dotnet/runtime:8.0 | rule | p_gate_with_exceptions | pass | 1 | 0 |
| mcr.microsoft.com/dotnet/runtime:8.0 | agent | p_gate | pass | 1 | 0 |
| mcr.microsoft.com/dotnet/runtime:8.0 | agent | p_gate_with_exceptions | pass | 1 | 0 |
| php:8.3-apache | rule | p_gate | pass | 0 | 0 |
| php:8.3-apache | rule | p_gate_with_exceptions | pass | 0 | 0 |
| php:8.3-apache | agent | p_gate | pass | 0 | 0 |
| php:8.3-apache | agent | p_gate_with_exceptions | pass | 0 | 0 |
| rust:1.82-slim | rule | p_gate | pass | 79 | 0 |
| rust:1.82-slim | rule | p_gate_with_exceptions | pass | 79 | 0 |
| rust:1.82-slim | agent | p_gate | pass | 79 | 0 |
| rust:1.82-slim | agent | p_gate_with_exceptions | pass | 79 | 0 |
| node:22 | rule | p_gate | pass | 6 | 0 |
| node:22 | rule | p_gate_with_exceptions | pass | 6 | 0 |
| node:22 | agent | p_gate | pass | 6 | 0 |
| node:22 | agent | p_gate_with_exceptions | pass | 6 | 0 |
| python:3.13-slim | rule | p_gate | pass | 1 | 0 |
| python:3.13-slim | rule | p_gate_with_exceptions | pass | 1 | 0 |
| python:3.13-slim | agent | p_gate | pass | 0 | 0 |
| python:3.13-slim | agent | p_gate_with_exceptions | pass | 0 | 0 |
