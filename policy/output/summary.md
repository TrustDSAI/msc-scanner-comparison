...
| node:14 | rule | p_gate | **BLOCK** | 314 | 0 |
| node:14 | rule | p_gate_with_exceptions | **BLOCK** | 314 | 0 |
| node:14 | agent | p_gate | **BLOCK** | 314 | 0 |
| node:14 | agent | p_gate_with_exceptions | **BLOCK** | 314 | 0 |
| python:3.8 | rule | p_gate | pass | 669 | 0 |
| python:3.8 | rule | p_gate_with_exceptions | pass | 669 | 0 |
| python:3.8 | agent | p_gate | pass | 669 | 0 |
| python:3.8 | agent | p_gate_with_exceptions | pass | 669 | 0 |
| vulnerables/web-dvwa | rule | p_gate | **BLOCK** | 789 | 0 |
| vulnerables/web-dvwa | rule | p_gate_with_exceptions | **BLOCK** | 789 | 0 |
| vulnerables/web-dvwa | agent | p_gate | **BLOCK** | 789 | 0 |
| vulnerables/web-dvwa | agent | p_gate_with_exceptions | **BLOCK** | 789 | 0 |
| bkimminich/juice-shop | rule | p_gate | **BLOCK** | 41 | 0 |
| bkimminich/juice-shop | rule | p_gate_with_exceptions | pass | 40 | 1 |
| bkimminich/juice-shop | agent | p_gate | **BLOCK** | 41 | 0 |
