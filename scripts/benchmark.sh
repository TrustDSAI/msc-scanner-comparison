...
SCAN_ORDER=(alpine_3.19 nginx_1.19 nginx_1.29.7 node_14 node_20 python_3.8 python_3.12 vulnerables_web-dvwa bkimminich_juice-shop)

# Pre-warm Trivy DB once so no mid-benchmark DB refresh skews timings.
